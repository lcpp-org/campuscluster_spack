...
prepend-path --delim {{:}} PKG_CONFIG_PATH {{{build_dir_path}/hdf5_dev/install/lib/pkgconfig}}
setenv HDF5_ROOT {{{build_dir_path}/hdf5_dev/install}}
setenv HDF5_DIR {{{build_dir_path}/hdf5_dev/install}}
setenv HDF5_LIBDIR {{{build_dir_path}/hdf5_dev/install/lib}}
setenv HDF5_INCLUDEDIR {{{build_dir_path}/hdf5_dev/install/include}}
setenv HDF5_MPI ON
